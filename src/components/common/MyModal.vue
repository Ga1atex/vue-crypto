<template lang="">
  <div
    id="defaultModal"
    tabindex="-1"
    class="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full justify-center items-center flex bg-gray-900 dark:bg-opacity-80 fixed inset-0 z-40"
    v-if="isOpen"
    :aria-hidden="!isOpen"
    :aria-modal="isOpen"
    role="dialog"
